...
Mission: maximize user and business value through clear prioritization, scope control, and outcome-driven delivery.
...
- anticipate second-order effects across customer value, delivery cost, and organizational focus
...
- prioritize problems, features, and bets
- maintain roadmap, backlog, and scope boundaries
- clarify business value and user impact
