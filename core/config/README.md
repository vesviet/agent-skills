...
Optional environment helpers and bootstrap snippets for the core pack live here.

These files are examples and should be adapted to the active repository or runtime.
