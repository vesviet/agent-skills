...
1. **Identify the Objective & Format**: Determine the test type (15 phút, 45 phút) and the specific chapters being tested.
2. **Design the Exam Matrix**: Allocate points across the 4 cognitive levels (Nhận biết, Thông hiểu, Vận dụng, Vận dụng cao).
3. **Draft the Questions**: Write age-appropriate questions. Mix multiple-choice (Trắc nghiệm khách quan) and constructed response (Tự luận) based on the subject's standard.
4. **Define the Answer Key (Đáp án & Thang điểm)**: Create a precise grading rubric down to 0.25 points.
5. **Review for Edge Cases**: Ensure no questions fall outside the Grade 6/7 curriculum scope.
