# Vesviet Content Roles

Overlay-specific role extensions can live here when the content pipeline needs toolbox or handoff behavior that should not live in the global core.
